...
<div class="_gaps_s">
	...
	<XFolder v-if="matchQuery([i18n.ts._role._options.antennaNotesMax, 'antennaNotesLimit'])" v-model:policyMeta="policyMetaModel.antennaNotesLimit" :isBaseRole="isBaseRole" :readonly="readonly">
